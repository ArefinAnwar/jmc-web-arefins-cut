        ...
        <div className="min-h-screen flex flex-col items-center bg-slate-950 justify-center py-10 px-4">
            ...
            {!loading && (
                <>
                    ...
                    <div className="w-full md:max-w-11/12 bg-blue-600/5 p-6 shadow-md rounded-lg grid grid-cols-1 md:grid-cols-4 h-auto justify-items-center justify-center">
                        {articles.map((article) => (
                            ...
                            />
                            // <li key={article.slug}>
                            // <a href={`/article/${article.slug}`}>{article.articleTitle}</a>
                            // </li>
                        ))}
...
function QuizCard({ title, link, time, image, imagee }) {
    ...
    return (
        ...
        <div className=" bg-blue-400 bg-opacity-30 mb-6 rounded-lg p-5 flex flex-col   items-center  md:mx-4  min-h-[20rem] w-[18rem]">
